# ----------------------------------------------------
# -- Practical => Loop on Many Iterators With Zip() --#تلخيص الفكره ان ال zip بيلوب علي اصغر عدد من العناصر 
# ----------------------------------------------------
# zip() Return A Zip Object Contains All Objects
# zip() Length Is The Length of Lowest Object#بستخدمه لضغط الملفات الكبيره
# ------------------------------------------------
